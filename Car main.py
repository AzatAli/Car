class Car:
        def __init__(self, model, size, color, doors, mileage):
                self.model = model
                self.size = size
                self.color = color
                self.doors = doors
